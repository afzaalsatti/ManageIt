...
export default class ExpenseDetails extends Component {
    ...
    },
    {
      ...
      renderTopRoutes=()=>{
        ...
        return latest_expenditures.map((element, index)=>{
            ...
            return  <li  style={{listStyle:"none",marginLeft:"10px",marginRight:"10px",color:"black"}}  >
                   <Card style={{height:"70px"}}>
                      <Card.Body style={{margin:"0px",padding:"0px",borderRadius:"10px",background:"fff"}}>
                        <div>
                        <h6 style={{    fontSize: "initial"}} >{element.type}</h6>
                       
                        </div>
                        <div style={{marginTop:"20px"}}>
                        <img style={{float:"left"}} src="/assets/images/ticket.png"></img>
                        <h5 style={{float:"left",marginLeft:"7px",fontSize: "initial"}}>{element.date}</h5>
                        <text  style={{float:"right",margin:"0px"}}>{element.amount}</text>
                        </div>
                      </Card.Body>
                    </Card>
...
<Card.Header>
<div>
    <h3 style={{float:"left"}}>Top Employees
...
<Card.Header>
<div>
    <h3 style={{float:"left"}}>Latest Expenses
...
<Bookings address="getAllExpenses"></Bookings>
</div>
