              ...
              <SettingsContent header>
                <SettingsPage handler="/settings/general">
                  ...
                  <fieldset className="form-group">
                    <text htmlFor="generalName">Name: </text>
                    <input
                      type="text"
                  ...
                  <fieldset className="form-group">
                    <text htmlFor="generalUsername">Username: </text>
                  ...
                  <fieldset className="form-group">
                    <text htmlFor="generalMail">E-Mail address: </text>
                    <input
                      type="text"
                      className="form-control"
                  ...
                  <fieldset className="form-group">
                    <text htmlFor="generalPic">Picture: </text>
                    <input
                      type="text"
                      className="form-control"
                  ...
                  <fieldset className="form-group">
                    <text htmlFor="profileColor">Color-Theme: </text>
                    <select
                ...
                <SettingsPage handler="/settings/profile">
                  ...
                  <fieldset className="form-group">
                    <text htmlFor="profileFirstname">Firstname: </text>
                    <input
                      type="text"
                      className="form-control"
                  ...
                  <fieldset className="form-group">
                    <text htmlFor="profileLastname">Lastname: </text>
                    <input
                      type="text"
                      className="form-control"
                  ...
                  <fieldset className="form-group">
                    <text htmlFor="profileBiography">Biography: </text>
                    <textarea
                      className="form-control"
                ...
                <SettingsPage handler="/settings/notifications">
                         ...
                         <SettingsPage handler="/settings/appearance">
                         </SettingsPage>
                         <SettingsPage handler="/settings/language">
                         </SettingsPage>
