...
this.getTicketPurchaseHistory()
    ...
    getTicketPurchaseHistory=()=>{
      ...
      let address="getTicketPurchaseHistory";
       let req_data={
    ...
    showRideDetails = list_item => e => {
      dropoffCords=ticketHistory[list_item].to;
      pickupCords=ticketHistory[list_item].from;
    ...
    getListItemCards=function(){
        ...
        return ticketHistory.map((key, index)=>{
          ...
          <div className="historytopdiv">
              ...
              <text className="moveToRight">RS {key.price}</text>
              <br></br>
