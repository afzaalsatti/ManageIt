                  ...
                  <div className="tab-pane" id="timeline">
                    ...
                    <div className="timeline timeline-inverse">
                      ...
                      <div>
                        ...
                        <div className="timeline-item">
                          <div>
                            <span classname="time"><i classname="far fa-clock"> 5 mins ago</i></span><i classname="far fa-clock">
                              ...
                              <div>
                                <i classname="fas fa-comments bg-warning">
                                  <div classname="timeline-item">
                                    <span classname="time"><i classname="far fa-clock"> 27 mins ago</i></span><i classname="far fa-clock">
                                    ...
                                    </i></div><i classname="far fa-clock">
                                  </i></i></div><i classname="fas fa-comments bg-warning"><i classname="far fa-clock">
                                  {'{'}/* END timeline item */{'}'}
                                  {'{'}/* timeline time label */{'}'}
                                  <div classname="time-label">
                                  ...
                                  <div>
                                    <i classname="fas fa-camera bg-purple">
                                      <div classname="timeline-item">
                                        <span classname="time"><i classname="far fa-clock"> 2 days ago</i></span><i classname="far fa-clock">
                                      ...
                                      </i></i></div><i classname="fas fa-camera bg-purple"><i classname="far fa-clock">
                                      {'{'}/* END timeline item */{'}'}
                                      <div>
                                        <i classname="far fa-clock bg-gray">
                                        </i></div><i classname="far fa-clock bg-gray">
                                        {'{'}/* /.tab-pane */{'}'}
                                        <div classname="tab-pane" id="settings">
                                          <form classname="form-horizontal">
                                            ...
                                            <div classname="form-group row">
                                              ...
                                              <div classname="col-sm-10">
                                                <textarea classname="form-control" id="inputExperience" placeholder="Experience" defaultvalue="{&quot;&quot;}" defaultValue={"        </div>\n      </div>\n      <div className=\"form-group row\">\n        <label htmlFor=\"inputSkills\" className=\"col-sm-2 col-form-label\">Skills</label>\n        <div className=\"col-sm-10\">\n          <input type=\"text\" className=\"form-control\" id=\"inputSkills\" placeholder=\"Skills\" />\n        </div>\n      </div>\n      <div className=\"form-group row\">\n        <div className=\"offset-sm-2 col-sm-10\">\n          <div className=\"checkbox\">\n            <label>\n              <input type=\"checkbox\" /> I agree to the <a href=\"#\">terms and conditions</a>\n            </label>\n          </div>\n        </div>\n      </div>\n      <div className=\"form-group row\">\n        <div className=\"offset-sm-2 col-sm-10\">\n          <button type=\"submit\" className=\"btn btn-danger\">Submit</button>\n        </div>\n      </div>\n    </form>\n  </div>\n  {/* /.tab-pane */}\n  {/* /.tab-content */}\n  {/* /.card-body */}\n  {/* /.nav-tabs-custom */}\n  {/* /.col */}\n  {/* /.row */}\n  {/* /.container-fluid */}\n  {/* /.content */}\n</div>\n"} /></div></div></form></div></i></i></i></i></i></i></div></div></div></div></div></div></div></div></div></div></div></section></div></div>
